...
import { assertUkCanaryHealthGate, executeUkCloudflareCanary } from '../operations/cloudflare-uk-canary/lib/uk-cloudflare-canary-execution.mjs';
...
const healthyGate = {
  ...
  checked_at: '2026-09-08T15:25:00.000Z',
...
test('UK canary health gate fails closed unless both trigger and describe probes are fresh and passed', () => {
  ...
  assert.throws(() => assertUkCanaryHealthGate({ ...healthyGate, checked_at: '2026-09-08T14:00:00.000Z' }, { now: NOW }), /stale or invalid/);
